...
# I run this 10,000,000 at a time to select all skills from the job ads we need from our onet codes in 2019
# skill1 <- DBI::dbGetQuery(con, "SELECT id, jobdate, skill, skillcluster, skillclusterfamily, isbaseline FROM bgt_job.skill
#                           WHERE jobdate >= '2019-01-01'
#                           AND jobdate < '2020-01-01'
#                           AND isbaseline = 'TRUE'
#                           AND id IN (SELECT id FROM bgt_job.main WHERE jobdate >= '2019-01-01' AND jobdate < '2020-01-01')
#                           OFFSET 0 ROWS
#                           FETCH FIRST 10000000 ROWS ONLY"
# )
#
# skill2 <- DBI::dbGetQuery(con, "SELECT id, jobdate, skill, skillcluster, skillclusterfamily, isbaseline FROM bgt_job.skill
#                           WHERE jobdate >= '2019-01-01'
#                           AND jobdate < '2020-01-01'
#                           AND isbaseline = 'TRUE'
#                           AND id IN (SELECT id FROM bgt_job.main WHERE jobdate >= '2019-01-01' AND jobdate < '2020-01-01')
...
# )
#
# skill3 <- DBI::dbGetQuery(con, "SELECT id, jobdate, skill, skillcluster, skillclusterfamily, isbaseline FROM bgt_job.skill
#                           WHERE jobdate >= '2019-01-01'
#                           AND jobdate < '2020-01-01'
#                           AND isbaseline = 'TRUE'
#                           AND id IN (SELECT id FROM bgt_job.main WHERE jobdate >= '2019-01-01' AND jobdate < '2020-01-01')
#                           OFFSET 20000000 ROWS
#                           FETCH FIRST 10000000 ROWS ONLY"
# )
#
# skill4 <- DBI::dbGetQuery(con, "SELECT id, jobdate, skill, skillcluster, skillclusterfamily, isbaseline FROM bgt_job.skill
#                           WHERE jobdate >= '2019-01-01'
#                           AND jobdate < '2020-01-01'
#                           AND isbaseline = 'TRUE'
#                           AND id IN (SELECT id FROM bgt_job.main WHERE jobdate >= '2019-01-01' AND jobdate < '2020-01-01')
...
# )
#
# skill5 <- DBI::dbGetQuery(con, "SELECT id, jobdate, skill, skillcluster, skillclusterfamily, isbaseline FROM bgt_job.skill
#                           WHERE jobdate >= '2019-01-01'
#                           AND jobdate < '2020-01-01'
#                           AND isbaseline = 'TRUE'
#                           AND id IN (SELECT id FROM bgt_job.main WHERE jobdate >= '2019-01-01' AND jobdate < '2020-01-01')
...
# )
#
# skill6 <- DBI::dbGetQuery(con, "SELECT id, jobdate, skill, skillcluster, skillclusterfamily, isbaseline FROM bgt_job.skill
#                           WHERE jobdate >= '2019-01-01'
#                           AND jobdate < '2020-01-01'
#                           AND isbaseline = 'TRUE'
#                           AND id IN (SELECT id FROM bgt_job.main WHERE jobdate >= '2019-01-01' AND jobdate < '2020-01-01')
...
# )
#
# skill7 <- DBI::dbGetQuery(con, "SELECT id, jobdate, skill, skillcluster, skillclusterfamily, isbaseline FROM bgt_job.skill
#                           WHERE jobdate >= '2019-01-01'
#                           AND jobdate < '2020-01-01'
#                           AND isbaseline = 'TRUE'
#                           AND id IN (SELECT id FROM bgt_job.main WHERE jobdate >= '2019-01-01' AND jobdate < '2020-01-01')
...
# )
#
# skill8 <- DBI::dbGetQuery(con, "SELECT id, jobdate, skill, skillcluster, skillclusterfamily, isbaseline FROM bgt_job.skill
#                           WHERE jobdate >= '2019-01-01'
#                           AND jobdate < '2020-01-01'
#                           AND isbaseline = 'TRUE'
#                           AND id IN (SELECT id FROM bgt_job.main WHERE jobdate >= '2019-01-01' AND jobdate < '2020-01-01')
...
# )
#
# skill9 <- DBI::dbGetQuery(con, "SELECT id, jobdate, skill, skillcluster, skillclusterfamily, isbaseline FROM bgt_job.skill
#                           WHERE jobdate >= '2019-01-01'
#                           AND jobdate < '2020-01-01'
#                           AND isbaseline = 'TRUE'
#                           AND id IN (SELECT id FROM bgt_job.main WHERE jobdate >= '2019-01-01' AND jobdate < '2020-01-01')
...
# skills <- rbind(skill1, skill2)
# skills <- rbind(skills, skill3)
# skills <- rbind(skills, skill4)
# skills <- rbind(skills, skill5)
# skills <- rbind(skills, skill6)
# skills <- rbind(skills, skill7)
# skills <- rbind(skills, skill8)
# skills <- rbind(skills, skill9)
#
# # skills <- unique(skills) #dropped some which means overlap
#
# # length(unique(skills$id)) #14,949,893 so obvi the select id clause didn't work lmao
# # over 6,000,000 job ads with our soc codes in 2019
#
#
# soc <- data.table(job, key="id")[
#   data.table(skills, key="id"),
