...
```
Our project highlights the interconnectivity of many Army occupations in regards to the set of skills that their occupants acquire. We analyzed skill acquisition according to three skill types: baseline, specialized, and software.
