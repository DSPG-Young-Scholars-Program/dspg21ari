...
cert <- DBI::dbGetQuery(con, "SELECT *
FROM bgt_res.cert WHERE id IN (", paste(ids, collapse = ", "), ")"))

ed <- DBI::dbGetQuery(con, "SELECT *
FROM bgt_res.ed WHERE id IN (", paste(ids, collapse = ", "), ")"))
  
pers <- DBI::dbGetQuery(con, "SELECT *
FROM bgt_res.pers WHERE id IN (", paste(ids, collapse = ", "), ")"))

skill <- DBI::dbGetQuery(con, "SELECT *
FROM bgt_res.skill WHERE id IN (", paste(ids, collapse = ", "), ")"))
