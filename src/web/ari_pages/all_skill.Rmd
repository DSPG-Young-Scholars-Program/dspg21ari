...
Based on the salary for each MOS based on their skill, the average salary for jobs acquired by soldiers once leaving the army based on their skills is consistent across MOS. This could be due to the number of overlapping skills and jobs shared across SOC codes, which are common amongst all MOS.
...
The software skills have the most consistent set of top 10 skills across MOS, with most sharing the same set of 10 skills. Some outliers include SQL for military police and AutoCAD for cannon crewmembers, infantrymen and M1 Armor Crewmen.


### Networks
![All skills network](./images/all_skills.png) 

![linking MOS and SOC codes](./images/mos_soc.png) 
