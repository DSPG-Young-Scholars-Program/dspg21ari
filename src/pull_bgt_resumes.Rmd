...
# load packages 
for (pkg in c("tidyverse", "data.table", "stringr", "stringi", "dplyr", "readr")) {
  library(pkg, character.only = TRUE)
}

Sys.setenv(db_usr = "mes5bu")
Sys.setenv(db_pwd = "mes5bu")
...
pers <- DBI::dbGetQuery(con, "SELECT * FROM bgt_job.main order by random()<=1000"
)
